...
$email = 'erictoddcreative@gmail.com';

// If the e-mail is not working, change the debug option to 2 | $debug = 2;
$debug = 0;

// If contact form don't has the subject input change the value of subject here
$subject = ( isset($_POST['Contact Form Entry']) ) ? $_POST['Contact Form Entry'] : 'Contact Form Entry';
...
try {
	...
	$mail->SetFrom('j.eric.todd@gmail.com', 'Website Contact');
